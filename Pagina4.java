...
public class Pagina4 implements ActionListener{
	...
	JLabel label1 = new JLabel("       Găsiți sub forma (reteta_id1, reteta_id2) perechi de rețete ce");
	JLabel label2 = new JLabel("  folosesc același ingredient în aceeași cantitate și unitate de măsură.");
	 	
	Border border = BorderFactory.createLineBorder(Color.BLACK);
	Border border1 = BorderFactory.createLineBorder(colorFundal);
	
    Pagina4(Vector data, Vector columnNames)
    {
    	frame = new JFrame();
	    frame.setTitle("Rezultat interogare 4");
		...
		returnBtn.setBounds(490, 420, 140, 40);
